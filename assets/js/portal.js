...
(function () {
  ...
  function midia(n, semLink) {
    var dentro = n.imagem
      ? '<img src="' + esc(n.imagem) + '" alt="' + esc(n.legenda || "") + '" loading="lazy" decoding="async" data-capa="' + esc(n.id) + '">'
      : capa(n);
    return semLink
      ? '<div class="midia">' + dentro + "</div>"
      : '<a class="midia" href="' + urlNoticia(n) + '" tabindex="-1" aria-hidden="true">' + dentro + "</a>";
  }
    ...
    return '<a class="pular" href="#conteudo">Pular para o conteúdo</a>' +
      ...
      '<nav class="menu" aria-label="Seções do portal"><div class="container">' +
        ...
        '<ul class="menu-lista">' +
          ...
          '<li><a href="index.html#grupo">O grupo</a></li>' +
  ...
  function rodape(cats) {
    ...
    return '<footer class="rodape"><div class="container rodape-grade">' +
        "<div>" +
        ...
        '<div><h2>O grupo</h2><ul><li><a href="index.html#grupo">Quem somos</a></li><li><a href="index.html#departamentos">Departamentos</a></li>' +
  ...
  function paginaInicial() {
    ...
    if (D.numeros && D.numeros.length) {
      h += '<section class="numeros" aria-labelledby="t-numeros">' + heliceDecorativa() + '<div class="container">' +
        ...
        '<div class="numeros-grade">' + D.numeros.map(function (x) {
          return '<div class="numero"><b>' + esc(x.valor) + "</b><span>" + esc(x.rotulo) + "</span></div>";
    ...
    h += '<section class="secao container" id="grupo" aria-labelledby="t-grupo">' +
      ...
      '<div class="grupo-grade"><div class="grupo-texto">' +
        ...
        (contato.email ? '<a class="botao botao-primario" href="#contato">Fale com o ' + esc(site.sigla) + icone("seta") + "</a>" : "") +
      "</div>" +
    ...
    if (contato.email || contato.instagram) {
      h += '<section class="contato" id="contato" aria-labelledby="t-contato"><div class="container">' +
        '<div><h2 id="t-contato">Fale com o ' + esc(site.sigla) + "</h2>" +
        "<p>Dúvidas, parcerias, visitas ou interesse em conhecer o trabalho do grupo? Escreva para a gente.</p></div>" +
  ...
  function paginaNoticia() {
    ...
    var topoMidia = yt
      ...
      : '<figure class="artigo-capa">' + midia(n, true) + (n.imagem && n.legenda ? "<figcaption>" + esc(n.legenda) + "</figcaption>" : "") + "</figure>";
